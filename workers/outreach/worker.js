...
const VER = 'v1.1';
const getAdminKey = (env) => env.ADMIN_KEY || '';  // 從 Cloudflare Secret 讀，不再硬編
...
export default {
  ...
  async fetch(request, env) {
    ...
    if (url.pathname === '/admin/board') {
      ...
      return new Response(boardHTML(groups, getAdminKey(env)), { headers: { 'Content-Type': 'text/html; charset=utf-8' } });
    }

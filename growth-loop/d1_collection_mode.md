...
| owner_evidence_valid | blocked | Owner D1 evidence must pass the local evidence contract. |
| recurring_aggregate_read_approved | blocked | Owner must explicitly approve recurring aggregate-only D1 reads. |
| post_gate_verification_ready | blocked | D1 post-gate verification plan must be ready. |

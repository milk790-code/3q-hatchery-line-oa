...
const AUTO_REPLIES = [
  ...
  { keywords: ['VIP 資源庫', 'VIP資源庫'],
    response: 'VIP 資源庫整理中…\n預計 v3.7 推出：\n• 行銷模板庫\n• 拍攝指南\n• 顧問月報\n\n敬請期待。' },
  // ── v3.7 彈藥：個人故事 ──
  { keywords: ['你是誰', '創辦人', '關於3Q', '3Q是誰', '學誼', '關於我們'],
    response: '25 歲，我才決定開始幫別人的品牌。\n\n不是太慢，是我不想在還沒走過的路上帶路。\n\n我自己做的是汽美耗材——不是餐飲、不是服飾，不是任何人眼中「容易做內容」的行業。但我花了三年，把一個沒人知道的台灣品牌做到 IG 13.6 萬追蹤、TikTok 單支影片 113 萬次觀看。\n\n那段過程讓我確認一件事：被看見，和你賣的是什麼無關，和你願不願意說清楚自己是誰有關。\n\n台灣有太多認真做事的人，每天在做很好的東西，卻因為不知道怎麼讓人看見而白白錯過。\n\n3Q 孵化所，是我給那些人準備的答案。' },
  // ── v3.7 彈藥：FAQ ──
  { keywords: ['不喜歡', '做出來不喜歡', '做完不喜歡', '不滿意怎麼', '重做嗎'],
    response: '做到你點頭為止，不是做到我們覺得好。\n\n初版方向跑掉，我們重來。進入月費之前，你沒有任何損失，也沒有任何義務。' },
  { keywords: ['網域費', '主機費', '維護費', '費用誰出', '後續費用'],
    response: '網域費用由你負擔，一年約 NT$500–1,000。\n\n主機費和維護費包含在月費方案裡——你不需要另外管伺服器、更新或備份，出問題我們修。' },
  { keywords: ['多久上線', '幾週完成', '需要幾天', '上線時間', '多快做好'],
    response: '標準時程 4 週：\n\n第 1 週：確認方向 + 蒐集素材\n第 2–3 週：開發\n第 4 週：你對照修正\n\n有過 3 週的案例，前提是你這端的素材和確認速度夠快。' },
  { keywords: ['只有台中', '不在台中', '外縣市', '遠端合作', '線上怎麼做'],
    response: '全台都做，完全線上。\n\n流程：LINE 對話確認需求 → 一次品牌訪談（Google Meet，約 1 小時）→ 進入製作 → 線上交付確認。\n\n你不需要到台中，我們也不需要到你那邊。' },
  { keywords: ['差在哪', '跟別人差', '有什麼不同', '跟設計公司'],
    response: '他們做完就交件；我們做完繼續養它。' },
];
...
async function sendReferralInvite(uid, env) {
  ...
  await fetch('https://api.line.me/v2/bot/message/push', {
    ...
    body: JSON.stringify({
      ...
      messages: [{
        type: 'text',
        text: `歡迎正式加入 3Q 孵化所夥伴！🎉\n\n你有 3 個引薦名額。\n你的專屬引薦碼：${code}\n\n複製這段訊息給你覺得需要被看見的朋友：\n———\n${shareText}\n———\n\n引薦成功後你得到：\n• 第 1 位成交 → 品牌健診加值（盤點+30分鐘覆診）\n• 第 3 位成交 → 加片/加報告/優先排程三選一\n• 第 5 位成交 → 超級引薦人禮遇`,
      }],
    }),
  }).catch(() => {});
}

...
// ─────────────────────────────────────────────────────────────────────────
const SUB_CATALOG = [
  { id: 'digital10', name: '30 人以下數位轉型培力補助', type: '補助', cap: 10, ease: 1, hook: '最高 10 萬直接補、不用還,最快核准', elig: { stages: ['new', 'mid'], biz: 'any', employees_max: 30 } },
  { id: 'cloudmkt', name: '雲市集數位點數', type: '補助', cap: 3, ease: 1, hook: '每年 3 萬點數,直接折抵 AI 軟體與系統費', elig: { stages: ['new', 'mid'], biz: 'any' } },
  ...
  { id: 'youth', name: '青年創業及啟動金貸款', type: '貸款', cap: 1200, ease: 2, hook: '18-45 歲、設立未滿 5 年,前幾年利息幾乎政府付', elig: { stages: ['pre', 'new', 'mid'], biz: 'any', within_years: 5 } },
